...
# the LSF_HEADNODE string should get replaced.
mkdir /opt/ibm
mount -t nfs -o rw,rsize=1048576,wsize=1048576,hard,timeo=600,retrans=2 LSF_HEADNODE:/opt/ibm /opt/ibm
mount -t nfs -o rw,rsize=1048576,wsize=1048576,hard,timeo=600,retrans=2 LSF_HEADNODE:/home /home
